...
class DataStatusList(
    delegateImpl: NestedListStatusDelegateInterface<ParentEditItem, ChildEditItem, EditItemModel>
) : ViewModel(),
    NestedListStatusDelegateInterface<ParentEditItem, ChildEditItem, EditItemModel> by delegateImpl {
    init {
